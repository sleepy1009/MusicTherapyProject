        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-left space-y-8 ">
            ...
            <motion.div 
              ...
              className="inline-flex items-center gap-2  px-4 py-2 rounded-full bg-white/5 border border-white/10 text-[#F5E8D8] text-sm font-medium"
            >
              <Sparkles className="w-4 h-4" />
              <span>Welcome to my universe</span>
            </motion.div>

            <h1 className="text-4xl font-out-text md:text-5xl font-bold leading-tight text-white">
              Đừng để âu lo <br />
              <span className="text-transparent font-out-text bg-clip-text bg-gradient-to-r from-[#1E90FF] to-[#FFFFFF] ">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <motion.button 
                ...
                whileTap={{ scale: 0.95 }}
                className="group relative px-6 py-4 bg-[#1E90FF]/90 hover:bg-[#1E90FF] rounded-2xl text-white font-bold text-lg transition-all shadow-lg hover:shadow-indigo-500/30 flex items-center gap-3 overflow-hidden"
              >
              ...
              <button className="px-8 py-4 bg-white/5 hover:bg-white/10 border border-white/10 rounded-2xl text-white font-medium text-lg transition-all backdrop-blur-sm flex items-center gap-3">
